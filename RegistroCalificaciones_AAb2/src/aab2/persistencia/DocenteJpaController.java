...
import aab2.persistencia.exceptions.NonexistentEntityException;
import aab2.persistencia.exceptions.PreexistingEntityException;
...
public class DocenteJpaController implements Serializable {
    ...
    public void create(Docente docente) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findDocente(docente.getCedula()) != null) {
